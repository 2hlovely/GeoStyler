...
_C.TRAINER.GEOSTYLER = CN()
_C.TRAINER.GEOSTYLER.WEIGHT_DIR_PATH = "weight/geostyler/checkpoint"
_C.TRAINER.GEOSTYLER.CHECK_POINT_NAME = "model.pth"
_C.TRAINER.GEOSTYLER.TRAIN_STYLE = False
# Orthogonality options for GeoStyler styles
_C.TRAINER.GEOSTYLER.ORTH_MODE = "E"
# Weight for the orthogonality regularization term
_C.TRAINER.GEOSTYLER.ORTH_LAMBDA = 0.0

# 
_C.DYNA_STYLER = CN()
_C.DYNA_STYLER.ENABLE = False
_C.DYNA_STYLER.TOPK_STYLES = 4
_C.DYNA_STYLER.TTA_STEPS = 3
_C.DYNA_STYLER.LR = 0.001
_C.DYNA_STYLER.SELECTION_P = 0.1
_C.DYNA_STYLER.LAMBDA = 0.1
_C.DYNA_STYLER.ALPHA = 0.5
_C.DYNA_STYLER.USE_GAP = False
_C.DYNA_STYLER.USE_WEIGHTED_ENSEMBLE = False
_C.DYNA_STYLER.TEMPERATURE = 1.0 
_C.DYNA_STYLER.SELECTION_MODE = "confidence"
